...
from src.data.globiom_residue_potential import pivot_globiom_crop_data_g
...
def calculate_crop_luc(focus_year):
    df_crop = pivot_globiom_crop_data_g()
...
def calculate_crop_luc_ghg(focus_year):
    ...
    df_impact['Transformation, from grassland, natural, for livestock grazing'] = df_impact[
                                                                                       'SG'] * 10000 / 20  # m2/ha/year
